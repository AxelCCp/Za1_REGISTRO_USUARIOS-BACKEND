...
INSERT INTO regiones(id, nombre) VALUES (9, 'Medio Oriente');

INSERT INTO paises(id, nombre) VALUES (1, 'EEUU');
INSERT INTO paises(id, nombre) VALUES (2, 'Canada');
INSERT INTO paises(id, nombre) VALUES (3, 'Mexico');
INSERT INTO paises(id, nombre) VALUES (4, 'Uruguay');
INSERT INTO paises(id, nombre) VALUES (5, 'Argentina');
INSERT INTO paises(id, nombre) VALUES (6, 'Qatar');
...
INSERT INTO usuarios(region_id, pais_id, nombre, apellido, email, number, edad, create_at) VALUES (2, 6,'MAASD','QW','QEEEW@KDJFH.COM','294862', 14,'2011-01-01');
INSERT INTO usuarios(region_id, pais_id, nombre, apellido, email, number, edad, create_at) VALUES (2, 1,'ASJHAS','AKSJHD','1HasASG@KDJFH.COM','12231234', 18,'2018-01-01');
INSERT INTO usuarios(region_id, pais_id, nombre, apellido, email, number, edad, create_at) VALUES (3, 2,'ZIZU','SDS','1A@KDJFH.COM','6432234', 20,'2019-01-01');
INSERT INTO usuarios(region_id, pais_id, nombre, apellido, email, number, edad, create_at) VALUES (1, 3,'OWR','ZXC','1ADS@KDJFH.COM','7384355643', 30,'2015-01-01');
INSERT INTO usuarios(region_id, pais_id, nombre, apellido, email, number, edad, create_at) VALUES (4, 7,'ZXCX','WQE','1DF@KDJFH.COM','172553176', 25,'2016-01-01');
INSERT INTO usuarios(region_id, pais_id, nombre, apellido, email, number, edad, create_at) VALUES (8, 7,'MKO','RTY','1XC@KDJFH.COM','987603456', 17,'2012-01-01');
INSERT INTO usuarios(region_id, pais_id, nombre, apellido, email, number, edad, create_at) VALUES (7, 7,'NMBFFS','QQW','1WER@KDJFH.COM','27238472', 24,'2018-01-01');
INSERT INTO usuarios(region_id, pais_id, nombre, apellido, email, number, edad, create_at) VALUES (5, 6,'QUTW','ZXC','1XCV@KDJFH.COM','2374286', 26,'2018-01-01');
INSERT INTO usuarios(region_id, pais_id, nombre, apellido, email, number, edad, create_at) VALUES (3, 5,'WMNWM','ERT','1XCVj@KDJFH.COM','384749590', 19,'2021-01-01');
INSERT INTO usuarios(region_id, pais_id, nombre, apellido, email, number, edad, create_at) VALUES (6, 3,'ZOCXIU','ZXC','1XCAV@KDJFH.COM','3766453', 16,'2022-01-01');
INSERT INTO usuarios(region_id, pais_id, nombre, apellido, email, number, edad, create_at) VALUES (4, 7,'AHSKJ','TYU','1HASDASG@KDJFH.COM','2873682', 15,'2010-01-01');
INSERT INTO usuarios(region_id, pais_id, nombre, apellido, email, number, edad, create_at) VALUES (2, 6,'MAASD','QW','1QEEEW@KDJFH.COM','2948862', 14,'2011-01-01');
INSERT INTO usuarios(region_id, pais_id, nombre, apellido, email, number, edad, create_at) VALUES (2, 1,'ASJHAS','AKSJHD','2HasASG@KDJFH.COM','124321234', 18,'2018-01-01');
...
INSERT INTO usuarios(region_id, pais_id, nombre, apellido, email, number, edad, create_at) VALUES (2, 1,'ASJHAS','AKSJHD','Ha2sASG@KDJFH.COM','12312734', 18,'2018-01-01');
INSERT INTO usuarios(region_id, pais_id, nombre, apellido, email, number, edad, create_at) VALUES (3, 2,'ZIZU','SDS','A2@KDJFH.COM','6422834', 20,'2019-01-01');
INSERT INTO usuarios(region_id, pais_id, nombre, apellido, email, number, edad, create_at) VALUES (1, 3,'OWR','ZXC','AD2S@KDJFH.COM','7389045643', 30,'2015-01-01');
...
INSERT INTO productos (nombre, precio, create_at) VALUES ('bicicleta rrr', 999999, NOW());
INSERT INTO productos (nombre, precio, create_at) VALUES ('mueble yyy', 111111, NOW());
INSERT INTO productos (nombre, precio, create_at) VALUES ('otra cosa', 5656565, NOW());

INSERT INTO facturas (descripcion, observacion, usuario_id, create_at) VALUES ('Factura equipos de oficina', 'muchas cosas', 1, now());
INSERT INTO facturas_items (cantidad, factura_id, producto_id) VALUES (1,1,1);
INSERT INTO facturas_items (cantidad, factura_id, producto_id) VALUES (2,1,4);
INSERT INTO facturas_items (cantidad, factura_id, producto_id) VALUES (1,1,5);
INSERT INTO facturas_items (cantidad, factura_id, producto_id) VALUES (1,1,7);

INSERT INTO facturas (descripcion, observacion, usuario_id, create_at) VALUES ('Factura Bicicleta', 'alguna nota importante', 1, now());
